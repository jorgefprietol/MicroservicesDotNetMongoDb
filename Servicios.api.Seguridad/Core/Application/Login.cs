...
namespace Servicios.api.Seguridad.Core.Application
{
    public class Login
    {
        ...
        public class UsuarioLoginHandler : IRequestHandler<UsuarioLoginCommand, UsuarioDto>
        {
            ...
            public UsuarioLoginHandler(SeguridadContexto context, UserManager<Usuario> userManeger, IMapper mapper, IJwtGenerator ijwtGenerator, SignInManager<Usuario> signInManager)
            {
                _context = context;
